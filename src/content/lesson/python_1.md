...
# menu: {'#начало': 'Начало', '#создание-бота': 'Создание бота', '#первый-скрипт': 'Первый скрипт', '#первый-обработчик': 'Первый обработчик', '#обработчики-команд': 'Обработчики команд', '#отправка-сообщений': 'Отправка сообщений'}
menu: [{title: 'Начало', path: '#начало'}, {title: 'Создание бота', path: '#создание бота'}, ]
---
